...
public class CommentsController {
    ...
    public ResponseEntity<CommentsVo> selectById(@RequestParam("comment_id") int commentId) throws Exception {
        CommentsVo comment = commentsService.selectById(commentId);
        if(comment != null) {
...
=======
    @PutMapping("/update")
    public ResponseEntity<String> update(@RequestParam("comment_id") int commentId, @RequestBody CommentsVo commentsVo) {
        log.info("put요청 제대로 수행되는지 확인 comment_id : " + commentId);
        log.info("Received request body: " + commentsVo);
...
=======
    @PutMapping("/ucv/updateCommentVisibility")
    public ResponseEntity<String> updateCommentVisibility(@RequestParam("comment_id") int commentId) {
>>>>>>> temp
        try {
...
=======
    @PutMapping("/replyUrv/updateReplyVisibility")
    public ResponseEntity<String> updateReplyVisibility(@RequestParam("comment_id") int commentId) {
>>>>>>> temp
        try {
